...
`kaos-llm-core` requires Python 3.13 or newer. It publishes the `kaos_llm_core`
import package. This package publishes CLI entry point(s): `kaos-llm-core`, `kaos-llm-core-serve`.
Public extras currently declared: `otel`, `vision`.
...
include the `kaos-llm-core` version, Python version, operating system,

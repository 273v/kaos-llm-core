...
This document defines how `kaos-llm-core` handles features, bugs,
...
- What `kaos-llm-core` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_llm_core`.

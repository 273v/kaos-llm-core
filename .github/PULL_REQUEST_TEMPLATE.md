...
See [CONTRIBUTING.md](https://github.com/273v/kaos-llm-core/blob/main/CONTRIBUTING.md)
...
- [ ] `uv run ruff format --check kaos_llm_core/ tests/` passes
- [ ] `uv run ruff check kaos_llm_core/ tests/` passes
- [ ] `uv run ty check kaos_llm_core/ tests/` passes
